...
session_guc bool		enable_distinct_reordering = true;
...
session_local planner_setup_hook_type planner_setup_hook = NULL;

/* Hook for plugins to get control before PlannerGlobal is discarded */
session_local planner_shutdown_hook_type planner_shutdown_hook = NULL;
