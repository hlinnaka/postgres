...
static SlruDesc MultiXactOffsetSlruDesc = {
	...
	.nslots = 0,				/* set later based on multixact_offset_buffers
								 * GUC */
...
static SlruDesc MultiXactMemberSlruDesc = {
	...
	.nslots = 0,				/* set later based on multixact_member_buffers
								 * GUC */
...
MultiXactShmemRequest(void *arg)
{
	...
	MultiXactShmemDesc.size = size;
	ShmemRequestStruct(&MultiXactShmemDesc);

	MultiXactOffsetSlruDesc.nslots = multixact_offset_buffers;
	SimpleLruRequest(&MultiXactOffsetSlruDesc);
	MultiXactMemberSlruDesc.nslots = multixact_member_buffers;
