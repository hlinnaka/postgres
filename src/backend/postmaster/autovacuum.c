...
session_local double		autovacuum_freeze_score_weight = 1.0;
session_local double		autovacuum_multixact_freeze_score_weight = 1.0;
session_local double		autovacuum_vacuum_score_weight = 1.0;
session_local double		autovacuum_vacuum_insert_score_weight = 1.0;
session_local double		autovacuum_analyze_score_weight = 1.0;
...
session_local int			Log_autoanalyze_min_duration = 600000;
