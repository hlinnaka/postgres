...
LockManagerShmemRequest(void *arg)
{
	...
	LockHashDesc.max_size = max_table_size;
	LockHashDesc.init_size = max_table_size / 2;
	ShmemRequestHash(&LockHashDesc);

	ProcLockHashDesc.max_size = max_table_size * 2;
	ProcLockHashDesc.init_size = max_table_size;
