...
extern session_guc bool Trace_connection_negotiation;
...
extern static_singleton const struct config_enum_entry wal_sync_method_options[];
...
DEFINE_BOOL_GUC_ADDR(backtrace_on_internal_error)
...
DEFINE_BOOL_GUC_ADDR(enable_self_join_removal)
...
DEFINE_STRING_GUC_ADDR(standby_slot_names)
