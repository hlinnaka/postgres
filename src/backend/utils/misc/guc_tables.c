...
session_guc bool		Debug_print_raw_parse = false;
...
postmaster_guc char	   *HostsFileName;
...
static session_guc char *log_min_messages_string;
...
static internal_guc int	effective_wal_level = WAL_LEVEL_REPLICA;
...
#endif
static internal_guc bool exec_backend_enabled = EXEC_BACKEND_ENABLED;
 ...
 */
suset_guc int			log_min_messages[] = {
