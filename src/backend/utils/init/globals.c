...
session_local volatile int ProcDieSenderPid = 0;
session_local volatile int ProcDieSenderUid = 0;
...
session_local uint8		MyCancelKey[MAX_CANCEL_KEY_LENGTH];
session_local int			MyCancelKeyLength = 0;
...
sighup_guc int			autovacuum_max_parallel_workers = 0;
