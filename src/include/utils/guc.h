...
extern PGDLLIMPORT session_guc bool Debug_print_raw_parse;
...
extern PGDLLIMPORT suset_guc int log_min_messages[];
...
extern PGDLLIMPORT postmaster_guc char *HostsFileName;
