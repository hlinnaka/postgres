...
extern void ShmemRequestStruct(ShmemStructDesc *desc);
extern void ShmemRequestHash(ShmemHashDesc *desc);
...
extern void shmem_hash_init(ShmemStructDesc *area_desc, void *ptr);
extern void shmem_hash_attach(ShmemStructDesc *area_desc, void *ptr);
